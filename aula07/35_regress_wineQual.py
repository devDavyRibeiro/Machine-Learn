...
X_train = scaler.fit_transform(X_train) # normaliza (padroniza) as variaveis de 0 a 1, ou seja, deixa o mínimo em 0 e máximo em 1 deixando todas as escalas iguais, evitando que uma variável com escala maior tenha mais influência no modelo do que outra com escala menor 
